...
SECRET_KEY = 'django-insecure-3yc+qc)*oawkl5l191pbn&ssb)=vu8z^n_v_wnn8o004#j!(p('
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # optional if you have project-wide templates
        'APP_DIRS': True,    
        'OPTIONS': {
            'context_processors': [
...
DEFAULT_FROM_EMAIL = f"Quiz App <{EMAIL_HOST_USER}>"



# For development, use console first:
